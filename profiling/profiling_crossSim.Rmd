...
# prepare simulation parameters for mapply
# prepare simulation parameters for mapply
simulParams_theory <- expand.grid(
  genoSize = genoSize,
  nCouples = nCouples
)
...
profileTime_theory(
  genoSize = simulParams_theory$genoSize[1],
...
simTimeSummary <- dta %>%
  group_by(genoSize, nCouples, nProgeny) %>%
  summarise(
